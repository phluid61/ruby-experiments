...
module StructuredHeaders
  ...
  def serialise_parameterised_list ary
    output = _empty_string
  ...
  def serialise_identifier input
    input = input.to_s
  ...
  def _discard_leading_OWS input_string
    input_string.sub!(LEADING_OWS, '')
  end

  def parse_header input_string, header_type
  ...
  def parse_dictionary input_string
    dictionary = {}
  ...
  def parse_parameterised_list input_string
    items = []
    until input_string.empty?
  ...
  def parse_parameterised_identifier input_string
  ...
  def parse_binary_content input_string
