...
# ISO-8859-3
#
CCS::ISO8859_3 = TableCCS.new('ISO-8859-3', 0, 255, iso8859_3_table) do
...
#
CCS::ISO8859_3_Strict = TableCCS.new('ISO-8859-3 (strict)', 0, 255, iso8859_3_table) do
  def valid? cp
    ((cp >= 0x20 && cp <= 0x7E) || (cp >= 0xA0 && cp <= 0xFF)) && super(cp)
  end
