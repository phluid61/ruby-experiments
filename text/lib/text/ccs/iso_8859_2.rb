...
table = [
  ...
  0x00A0,0x0104,0x02D8,0x0141,0x00A4,0x013D,0x015A,0x00A7,0x00A8,0x0160,0x015E,0x0164,0x0179,0x00AD,0x017D,0x017B, # A_
  0x00B0,0x0105,0x02DB,0x0142,0x00B4,0x013E,0x015B,0x02C7,0x00B8,0x0161,0x015F,0x0165,0x017A,0x02DD,0x017E,0x017C, # B_
  0x0154,0x00C1,0x00C2,0x0102,0x00C4,0x0139,0x0106,0x00C7,0x010C,0x00C9,0x0118,0x00CB,0x011A,0x00CD,0x00CE,0x010E, # C_
  0x0110,0x0143,0x0147,0x00D3,0x00D4,0x0150,0x00D6,0x00D7,0x0158,0x016E,0x00DA,0x0170,0x00DC,0x00DD,0x0162,0x00DF, # D_
  0x0155,0x00E1,0x00E2,0x0103,0x00E4,0x013A,0x0107,0x00E7,0x010D,0x00E9,0x0119,0x00EB,0x011B,0x00ED,0x00EE,0x010F, # E_
...
#
CCS::ISO_8859_2 = TableCCS.new('ISO-8859-2', 0, 255, table) do
...
CCS::LATIN_2       = CCS::ISO_8859_2
CCS::CP852         = CCS::ISO_8859_2
CCS::WINDOWS_28592 = CCS::ISO_8859_2

CCS::CentralEuropean = CCS::ISO_8859_2

##
# ISO-8859-2, strict mode (no control characters)
#
CCS::ISO_8859_2_Strict = TableCCS.new('ISO-8859-2 (strict)', 0x20, 0xFF, table) do
  def valid? cp
