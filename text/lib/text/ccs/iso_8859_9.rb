...
table = [
  ...
  0x011E,0x00D1,0x00D2,0x00D3,0x00D4,0x00D5,0x00D6,0x00D7,0x00D8,0x00D9,0x00DA,0x00DB,0x00DC,0x0130,0x015E,0x00DF, # D_
  0x00E0,0x00E1,0x00E2,0x00E3,0x00E4,0x00E5,0x00E6,0x00E7,0x00E8,0x00E9,0x00EA,0x00EB,0x00EC,0x00ED,0x00EE,0x00EF, # E_
  0x011F,0x00F1,0x00F2,0x00F3,0x00F4,0x00F5,0x00F6,0x00F7,0x00F8,0x00F9,0x00FA,0x00FB,0x00FC,0x0131,0x015F,0x00FF, # F_
  #   _0     _1     _2     _3     _4     _5     _6     _7     _8     _9     _A     _B     _C     _D     _E     _F
].freeze
...
#
CCS::ISO_8859_9 = TableCCS.new('ISO-8859-9', 0, 255, table) do
...
CCS::LATIN_5       = CCS::ISO_8859_9
CCS::CP920         = CCS::ISO_8859_9
CCS::WINDOWS_28599 = CCS::ISO_8859_9

CCS::Turkish       = CCS::ISO_8859_9
