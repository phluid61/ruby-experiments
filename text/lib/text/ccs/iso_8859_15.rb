...
table = [
  ...
  0x00A0,0x00A1,0x00A2,0x00A3,0x20AC,0x00A5,0x0160,0x00A7,0x0161,0x00A9,0x00AA,0x00AB,0x00AC,0x00AD,0x00AE,0x00AF, # A_
  0x00B0,0x00B1,0x00B2,0x00B3,0x017D,0x00B5,0x00B6,0x00B7,0x017E,0x00B9,0x00BA,0x00BB,0x0152,0x0153,0x0178,0x00BF, # B_
  0x00C0,0x00C1,0x00C2,0x00C3,0x00C4,0x00C5,0x00C6,0x00C7,0x00C8,0x00C9,0x00CA,0x00CB,0x00CC,0x00CD,0x00CE,0x00CF, # C_
  0x00D0,0x00D1,0x00D2,0x00D3,0x00D4,0x00D5,0x00D6,0x00D7,0x00D8,0x00D9,0x00DA,0x00DB,0x00DC,0x00DD,0x00DE,0x00DF, # D_
...
#
CCS::ISO_8859_15 = TableCCS.new('ISO-8859-15', 0, 255, table) do
...
CCS::LATIN_9       = CCS::ISO_8859_15
CCS::WINDOWS_28605 = CCS::ISO_8859_15
CCS::CP923         = CCS::ISO_8859_15

##
# ISO-8859-15, strict mode (no control characters)
#
CCS::ISO_8859_15_Strict = TableCCS.new('ISO-8859-15 (strict)', 0x20, 0xFF, table) do
  def valid? cp
