...
# ISO-8859-4
#
CCS::ISO8859_4 = CCS.new('ISO-8859-4', 0, 255) do
  def to_ucs cp
    CCS::ISO8859_4_FORWARD[cp] or raise CES::EncodingError, "invalid codepoint #{render_codepoint cp}"
  end

  def from_ucs cp
    CCS::ISO8859_4_REVERSE[cp] or raise CES::EncodingError, "invalid codepoint #{render_codepoint cp}"
  end
...
#
CCS::ISO8859_4_Strict = CCS.new('ISO-8859-4 (strict)', 0, 255) do
  def valid? cp
...
CCS::ISO8859_4_FORWARD = [
  ...
  0x00A0,0x0104,0x0138,0x0156,0x00A4,0x0128,0x013B,0x00A7,0x00A8,0x0160,0x0112,0x0122,0x0166,0x00AD,0x017D,0x00AF, # A_
  0x00B0,0x0105,0x02DB,0x0157,0x00B4,0x0129,0x013C,0x02C7,0x00B8,0x0161,0x0113,0x0123,0x0167,0x014A,0x017E,0x014B, # B_
  0x0100,0x00C1,0x00C2,0x00C3,0x00C4,0x00C5,0x00C6,0x012E,0x010C,0x00C9,0x0118,0x00CB,0x0116,0x00CD,0x00CE,0x012A, # C_
  0x0110,0x0145,0x014C,0x0136,0x00D4,0x00D5,0x00D6,0x00D7,0x00D8,0x0172,0x00DA,0x00DB,0x00DC,0x0168,0x016A,0x00DF, # D_
  0x0101,0x00E1,0x00E2,0x00E3,0x00E4,0x00E5,0x00E6,0x012F,0x010D,0x00E9,0x0119,0x00EB,0x0117,0x00ED,0x00EE,0x012B, # E_
  0x0111,0x0146,0x014D,0x0137,0x00F4,0x00F5,0x00F6,0x00F7,0x00F8,0x0173,0x00FA,0x00FB,0x00FC,0x0169,0x016B,0x02D9, # F_
  #   _0     _1     _2     _3     _4     _5     _6     _7     _8     _9     _A     _B     _C     _D     _E     _F
].freeze
CCS::ISO8859_4_REVERSE = Hash[CCS::ISO8859_4_FORWARD.each_with_index.map {|e, i| [e, i] }]
