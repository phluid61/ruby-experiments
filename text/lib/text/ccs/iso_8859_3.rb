...
table = [
  ...
  0x00A0,0x0126,0x02D8,0x00A3,0x00A4,0xA5,  0x0124,0x00A7,0x00A8,0x0130,0x015E,0x011E,0x0134,0x00AD,0xAE,  0x017B, # A_
  0x00B0,0x0127,0x00B2,0x00B3,0x00B4,0x00B5,0x0125,0x00B7,0x00B8,0x0131,0x015F,0x011F,0x0135,0x00BD,0xBE,  0x017C, # B_
  0x00C0,0x00C1,0x00C2,0xC3,  0x00C4,0x010A,0x0108,0x00C7,0x00C8,0x00C9,0x00CA,0x00CB,0x00CC,0x00CD,0x00CE,0x00CF, # C_
  0xD0,  0x00D1,0x00D2,0x00D3,0x00D4,0x0120,0x00D6,0x00D7,0x011C,0x00D9,0x00DA,0x00DB,0x00DC,0x016C,0x015C,0x00DF, # D_
  0x00E0,0x00E1,0x00E2,0xE3,  0x00E4,0x010B,0x0109,0x00E7,0x00E8,0x00E9,0x00EA,0x00EB,0x00EC,0x00ED,0x00EE,0x00EF, # E_
  0xF0,  0x00F1,0x00F2,0x00F3,0x00F4,0x0121,0x00F6,0x00F7,0x011D,0x00F9,0x00FA,0x00FB,0x00FC,0x016D,0x015D,0x02D9, # F_
  #   _0     _1     _2     _3     _4     _5     _6     _7     _8     _9     _A     _B     _C     _D     _E     _F
].freeze
...
#
CCS::ISO_8859_3 = TableCCS.new('ISO-8859-3', 0, 255, table) do
...
CCS::LATIN_3       = CCS::ISO_8859_3
CCS::CP913         = CCS::ISO_8859_3
CCS::WINDOWS_28593 = CCS::ISO_8859_3

CCS::SouthEuropean = CCS::ISO_8859_3

##
# ISO-8859-3, strict mode (no control characters)
#
CCS::ISO_8859_3_Strict = TableCCS.new('ISO-8859-3 (strict)', 0x20, 0xFF, table) do
  def valid? cp
    ((cp >= 0x20 && cp <= 0x7E) || (cp >= 0xA0 && cp <= 0xFF)) && cp != 0xA5 && cp != 0xAE && cp != 0xBE && cp != 0xC3 && cp != 0xD0 && cp != 0xE3 && cp != 0xF0
  end
