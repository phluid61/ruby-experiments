...
table = [
  ...
  0x00A0,0x0401,0x0402,0x0403,0x0404,0x0405,0x0406,0x0407,0x0408,0x0409,0x040A,0x040B,0x040C,0x00AD,0x040E,0x040F, # A_
  ...
  0x2116,0x0451,0x0452,0x0453,0x0454,0x0455,0x0456,0x0457,0x0458,0x0459,0x045A,0x045B,0x045C,0x00A7,0x045E,0x045F, # F_
  #   _0     _1     _2     _3     _4     _5     _6     _7     _8     _9     _A     _B     _C     _D     _E     _F
].freeze
...
#
CCS::ISO_8859_5 = TableCCS.new('ISO-8859-5', 0, 255, table) do
...
CCS::LATIN_CYRILLIC= CCS::ISO_8859_5
CCS::WINDOWS_28595 = CCS::ISO_8859_5
